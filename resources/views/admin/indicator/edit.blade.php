                    ...
                    <div class="jarviswidget jarviswidget-color-blueDark"
                        ...
                        <div>
                            ...
                            <div class="widget-body no-padding">
                                {!! Form::model( $indicator, ['route' => ['admin.indicator.update', $indicator->id], 'method' => 'POST','class' => 'smart-form', 'id' => 'form_edit_indicator'] ) !!}

                                @include($view_path.'.partials._indicator_form')


                                {{-- tab end --}}
                                <footer>
                                    {!! Form::button( trans($admin_trans_path.'general.button.update'), ['class' => 'btn btn-primary', 'type' => 'submit'] ) !!}
                                    <a class="btn btn-default" href="{!! route('admin.indicator') !!}" title="{{ trans($admin_trans_path.'general.button.cancel') }}">
