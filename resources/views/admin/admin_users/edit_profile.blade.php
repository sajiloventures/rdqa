                    ...
                    <div class="jarviswidget jarviswidget-color-blueDark"
                        ...
                        <div>
                            ...
                            <div class="widget-body no-padding">
                                {!! Form::model( $user, ['route' => ['admin.user.profile'], 'method' => 'POST','class' => 'smart-form', 'id' => 'form_edit_user'] ) !!}

                                @include($view_path.'.partials._user_profile')


                                {{-- tab end --}}
                                <footer>
                                    {!! Form::button( trans($admin_trans_path.'general.button.update'), ['class' => 'btn btn-primary', 'type' => 'submit'] ) !!}
                                    <a class="btn btn-default" href="{!! route('admin.admin_users') !!}" title="{{ trans($admin_trans_path.'general.button.cancel') }}">
