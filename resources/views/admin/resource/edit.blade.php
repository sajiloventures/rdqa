                    ...
                    <div class="jarviswidget jarviswidget-color-blueDark"
                        ...
                        <div>
                            ...
                            <div class="widget-body no-padding">
                                {!! Form::model( $resource, ['route' => [$base_route . '.update', $resource->id], 'method' => 'POST','class' => 'smart-form', 'id' => 'form_edit_resource', "enctype"=>"multipart/form-data"] ) !!}

                                @include($view_path.'.partials._resource_form')


                                {{-- tab end --}}
                                <footer>
                                    {!! Form::button( trans($admin_trans_path.'general.button.update'), ['class' => 'btn btn-primary', 'type' => 'submit'] ) !!}
                                    <a class="btn btn-default" href="{!! route($base_route) !!}" title="{{ trans($admin_trans_path.'general.button.cancel') }}">
