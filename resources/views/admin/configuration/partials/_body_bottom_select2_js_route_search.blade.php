<!-- Select2 4.0.0 -->
<script src="{{ asset (config('rdqa.asset_path.bower')."admin-lte/select2/js/select2.min.js") }}" type="text/javascript"></script>
...
<script type="text/javascript">
    ...
    $("#btn-add-route").on("click", function () {
        ...
        var urlShowRoute = '{!! url("admin/routes/{routes}") !!}'.replace('{routes}', routeID);
