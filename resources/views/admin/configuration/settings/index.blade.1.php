                ...
                <article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    ...
                    <div class="jarviswidget jarviswidget-color-blueDark"
                        ...
                        <div>
                            ...
                            {!! Form::open( ['route' => 'admin.permissions.store', 'id' => 'form_edit_permission','class' => 'smart-form'] ) !!}
                             
                                @include($view_path.'.partials._setting_form')

                            <footer>
                            {!! Form::button( trans($admin_trans_path.'general.button.save'), ['class' => 'btn btn-primary', 'id' => 'btn-submit-edit'] ) !!}
