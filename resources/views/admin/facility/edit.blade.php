                    ...
                    <div class="jarviswidget jarviswidget-color-blueDark"
                        ...
                        <div>
                            ...
                            <div class="widget-body no-padding">
                                {!! Form::model( $facility, ['route' => ['admin.facility.update', $facility->id], 'method' => 'POST','class' => 'smart-form', 'id' => 'form_edit_facility'] ) !!}

                                @include($view_path.'.partials._facility_form')


                                {{-- tab end --}}
                                <footer>
                                    {!! Form::button( trans($admin_trans_path.'general.button.update'), ['class' => 'btn btn-primary', 'type' => 'submit'] ) !!}
                                    <a class="btn btn-default" href="{!! route('admin.facility') !!}" title="{{ trans($admin_trans_path.'general.button.cancel') }}">
