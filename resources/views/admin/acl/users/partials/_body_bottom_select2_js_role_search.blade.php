...
<script type="text/javascript">
    ...
    $("#btn-add-role").on("click", function () {
        ...
        var urlShowRole = '{!! url("admin/roles/{roles}") !!}'.replace('{roles}', roleID);
...
//                console.log(data);
                ...
                if (1 == roleEnabled) {
                    roleStatus = '<i class="fa fa-fw fa-lg fa-check txt-color-green"></i>';
                }
                else {
                    roleStatus = '<i class="fa fa-fw fa-lg fa-check txt-color-red"></i>';
                }
                ...
                actionCel = '<td style="text-align: right"><a class="btn-remove-role" href="#" title="{{ trans('admin.general.button.remove-role') }}"><i class="fa fa-fw fa-lg fa-trash-o txt-muted txt-color-red deletable"></i></a></td>';
