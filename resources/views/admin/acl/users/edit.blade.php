                ...
                <div class="jarviswidget jarviswidget-color-blueDark"
                    ...
                    <div>
                        ...
                        <div class="widget-body no-padding">
                            {!! Form::model( $user, ['route' => ['admin.users.update', $user->id], 'method' => 'POST','class' => 'smart-form', 'id' => 'form_edit_user'] ) !!}
                        ...
                        {{-- tab end --}}
                            <footer>
                                {!! Form::button( trans($admin_trans_path.'general.button.update'), ['class' => 'btn btn-primary', 'id' => 'btn-submit-edit'] ) !!}
