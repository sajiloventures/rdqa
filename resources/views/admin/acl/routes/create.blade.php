...
<div id="content">
  ...
  {!! Form::open( ['route' => 'admin.users.store', 'id' => 'form_edit_user','class' => 'smart-form'] ) !!}
            ...
            @include($view_path.'.partials._route_form')
                        ...
                        {{-- tab end --}}
                            <footer>
                                ...
                                <a class="btn btn-default" href="{!! route('admin.routes.index') !!}" title="{{ trans($admin_trans_path.'general.button.cancel') }}">
