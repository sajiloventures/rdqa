...
//                console.log(data);
                ...
                if (1 == roleEnabled) {
                    ...
                    roleStatus = '<i class="fa fa-fw fa-lg fa-close txt-color-red"></i>';
                }
                ...
                actionCel = '<td style="text-align: right"><a class="btn-remove-role" href="#" title="{{ trans('admin.general.button.remove-role') }}"><i class="fa  fa-fw fa-lg fa-trash-o txt-color-red deletable deletable"></i></a></td>';
