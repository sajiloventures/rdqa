                    ...
                    <div class="jarviswidget jarviswidget-color-blueDark"
                        ...
                        <div>
                            ...
                            <div class="widget-body no-padding">
                                {!! Form::model( $compare_sheet, ['route' => ['admin.compare_sheet.update', $compare_sheet->id], 'method' => 'POST','class' => 'smart-form', 'id' => 'form_edit_compare_sheet'] ) !!}

                                @include($view_path.'.partials._compare_sheet_form')


                                {{-- tab end --}}
                                <footer>
                                    {!! Form::button( trans($admin_trans_path.'general.button.update'), ['class' => 'btn btn-primary', 'type' => 'submit'] ) !!}
                                    <a class="btn btn-default" href="{!! route('admin.compare_sheet') !!}" title="{{ trans($admin_trans_path.'general.button.cancel') }}">
