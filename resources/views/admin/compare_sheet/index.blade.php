                            ...
                            <div class="widget-body">
                                ...
                                <div class="row">
                                    <div class="col-sm-12" style="padding: 5px 20px 0 20px;">
                                        ...
                                        {!! Form::open( ['method' => 'POST' , 'id' => 'compare_sheet_list'] ) !!}

                                            @include($view_path . '.partials._compare_sheet_list')
...
@section('page_specific_scripts')
    <script>
        var dataTableConfigVariable = {
            route_url: {
                dataTable_url:  '{{ route("admin.compare_sheet.search") }}'
            },
            columns: [
                {data: 'id', name: 'id'},
                {data: 'name', name: 'name'},
    ...
    @if (AclHelper::isRouteAccessable('admin.compare_sheet.delete:GET'))
        <script>
            $('table').on('click', '.deleteCompareSheet', function (e) {
                e.preventDefault();
                var modal = $("#compare_sheetModal");
                modal.find('.modal-title span').html($(this).attr("attr-name"));
                modal.find('.deleteCompareSheetFinal').attr('href', $(this).attr("attr-compare_sheet-code"));
                modal.modal('show');
            });
        </script>

        <!-- Compare_sheet Delete Confirmation Modal -->
        <div class="modal fade" id="compare_sheetModal" tabindex="-1" role="dialog" aria-labelledby="compare_sheetModal" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <input type="hidden" name="id" class="compare_sheetId">
                    ...
                    <div class="modal-footer">
                        ...
                        <a href="#" type="button" class="btn btn-danger deleteCompareSheetFinal">
